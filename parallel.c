//implement parallel projection in 3d object using graphics.h
#include <stdio.h>
#include <graphics.h>
#include <math.h>
...
void parallelProjection(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, int x5, int y5, int x6, int y6, int x7, int y7, int x8, int y8, int d)
{
    int x1_new = x1 * d / y1;
    int y1_new = y1 * d / y1;
    int x2_new = x2 * d / y2;
...
int main()
{
    ...
    parallelProjection(x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, x6, y6, x7, y7, x8, y8, d);
    delay(5000);
    closegraph();
    return 0;
}
